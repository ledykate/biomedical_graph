...
INSERT INTO basic_name_indicator (Latin_name, Short_name, idSystem, idType_indicator) VALUES('Wein Index Speciei periphericis resistentia', 'WISPR', 2, 2);
...
UPDATE formed_idicator_method SET idMethod = NULL;
UPDATE formed_idicator_method SET idMethod = NULL;
UPDATE formed_idicator_method SET idMethod = NULL;
UPDATE formed_idicator_method SET idMethod = NULL;
UPDATE formed_idicator_method SET idMethod = 1;
UPDATE formed_idicator_method SET idMethod = 1;
UPDATE formed_idicator_method SET idMethod = 1;
UPDATE formed_idicator_method SET idMethod = 1;
UPDATE formed_idicator_method SET idMethod = NULL;
UPDATE formed_idicator_method SET idMethod = 2;
UPDATE formed_idicator_method SET idMethod = 3;
UPDATE formed_idicator_method SET idMethod = 3;
UPDATE formed_idicator_method SET idMethod = 3;
UPDATE formed_idicator_method SET idMethod = 3;
UPDATE formed_idicator_method SET idMethod = 3;
...
UPDATE formed_idicator_method SET idMethod = 3;
UPDATE formed_idicator_method SET idMethod = 3;
UPDATE formed_idicator_method SET idMethod = 4;
UPDATE formed_idicator_method SET idMethod = 5;
UPDATE formed_idicator_method SET idMethod = 6;
UPDATE formed_idicator_method SET idMethod = 6;
UPDATE formed_idicator_method SET idMethod = 6;
...
UPDATE unit_form_basic SET idFormula = 19;
UPDATE unit_form_basic SET idFormula = 1;
UPDATE unit_form_basic SET idFormula = 2;
UPDATE unit_form_basic SET idFormula = 3;
UPDATE unit_form_basic SET idFormula = 4;
UPDATE unit_form_basic SET idFormula = 5;
UPDATE unit_form_basic SET idFormula = 6;
UPDATE unit_form_basic SET idFormula = 7;
UPDATE unit_form_basic SET idFormula = 8;
UPDATE unit_form_basic SET idFormula = 9;
UPDATE unit_form_basic SET idFormula = 10;
UPDATE unit_form_basic SET idFormula = 11;
UPDATE unit_form_basic SET idFormula = 12;
UPDATE unit_form_basic SET idFormula = 22;
UPDATE unit_form_basic SET idFormula = 21;
UPDATE unit_form_basic SET idFormula = 20;
UPDATE unit_form_basic SET idFormula = 13;
UPDATE unit_form_basic SET idFormula = 14;
UPDATE unit_form_basic SET idFormula = 16;
UPDATE unit_form_basic SET idFormula = 17;
UPDATE unit_form_basic SET idFormula = 23;
UPDATE unit_form_basic SET idFormula = 18;
INSERT INTO unit_form_basic (idFormula, idBasicName) VALUES(15, 41);
INSERT INTO unit_form_basic (idFormula, idBasicName) VALUES(24, 44);
...
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ММВ', 'Максимальная мышечная выносливость', 1, 24);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('Т', 'Длительность стереотипных движений', 1, 25);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('Ан', 'Амплитуда мышечного движения в начале работы', 1, 27);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('Ак', 'Амплитуда мышечного движения в конце работы', 1, 28);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('КВ', 'Индекс Квааса', 1, 29);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('IМ', 'Индекс Мызникова', 1, 30);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ЭФдс', 'Показатель экономичности функционирования дыхательной системы', 1, 31);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('УрС', 'Уровень стресса', 1, 32);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('УФС', 'Уровень физического состояни', 1, 33);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ИМТ', 'Индекс массы тела', 1, 34);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ЖИ', 'Жизненный индекс Эрисмана', 1, 35);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ИФИ', 'Индекс функциональных изменений', 1, 36);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('РИ', 'Индекс Рида', 1, 37);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ИР', 'Индекс Робинсона', 1, 38);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ВИК', 'Оценка состояния вегетативной нервной системы', 1, 39);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ИВ', 'Индекс Вейна', 1, 40);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('УПС', 'Удельное периферическое сопротивление', 1, 42);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ИПСС', 'Индекс периферического сопротивления сосудов', 1, 43);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('УО', 'Ударный объем крови', 1, 44);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ОПС', 'Общее периферическое сопротивление', 1, 45);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ЖЕЛ', 'Жизненная емкость легких', 1, 46);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ПД', 'Пульсовое артериальное давление', 1, 47);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ПСС', 'Индекс периферического сопротивления сосудов', 1, 42);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('СО', 'Систолический объем крови', 1, 41);