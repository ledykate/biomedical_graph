...
INSERT INTO basic_name_indicator (Latin_name, Short_name, idSystem, idType_indicator) VALUES('Speciei periphericis resistentia', 'WISPR', 2, 2);
...
UPDATE unit_form_basic SET idFormula = 16 WHERE idBasicName = 42;
UPDATE unit_form_basic SET idFormula = 17 WHERE idBasicName = 43;
UPDATE unit_form_basic SET idFormula = 23 WHERE idBasicName = 44;
UPDATE unit_form_basic SET idFormula = 18 WHERE idBasicName = 45;
...
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ИПСС', 'Индекс периферического сопротивления сосудов', 1, 40);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ПСС', 'Периферического сопротивления сосудов', 1, 41);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('УО', 'Ударный объем крови', 1, 42);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ОПС', 'Общее периферическое сопротивление', 1, 43);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ЖЕЛ', 'Жизненная емкость легких', 1, 44);
INSERT INTO additional_name (Abbreviation_add_name, Decoding_abbrev, idLanguage, idBasicName) VALUES('ПД', 'Пульсовое артериальное давление', 1, 45);